...
public class ModernChessBoard extends JPanel {
    ...
    // Cores modernas para o tabuleiro
    private static final Color LIGHT_SQUARE = new Color(240, 217, 181);
    private static final Color DARK_SQUARE = new Color(181, 136, 99);
    private static final Color SELECTED_HIGHLIGHT = new Color(255, 255, 0, 120);
    private static final Color LEGAL_MOVE_HIGHLIGHT = new Color(0, 255, 0, 80);
    private static final Color LAST_MOVE_HIGHLIGHT = new Color(255, 165, 0, 100);
    private static final Color CHECK_HIGHLIGHT = new Color(255, 0, 0, 120);
    ...
    public ModernChessBoard(boolean showCoordinates) {
    ...
    private void initializeBoard() {
        ...
        for (int row = 0; row < 8; row++) {
            for (int col = 0; col < 8; col++) {
                ModernSquareButton square = new ModernSquareButton(row, col);
     ...
     */
    private static class ModernSquareButton extends JButton {
        ...
        public ModernSquareButton(int row, int col) {
            this.row = row;
            this.col = col;
    ...
    public void setSquareHighlight(int row, int col, HighlightType type) {
        if (squares[row][col] instanceof ModernSquareButton square) {
