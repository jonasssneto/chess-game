...
public class ModernButton extends JButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!isPressed && isEnabled()) {
            ...
            g2d.fillRoundRect(2, 2, width - 2, height - 2, 10, 10);
        }
        ...
        if (isPressed) {
            ...
            g2d.fillRoundRect(1, 1, width - 4, height - 4, 6, 6);
        } else if (isHovered) {
            // Highlight sutil quando hover
    ...
    public Dimension getPreferredSize() {
        ...
        return new Dimension(Math.max(size.width + 20, 120), Math.max(size.height, 40));
    }
}
